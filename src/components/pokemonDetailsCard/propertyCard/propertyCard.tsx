            ...
            <div className='flex-col'>
              ...
              <div className='prop-header-data'>
                <div className='type-wrap'>
                  {data.types.length && (data.types.map((item: { type: { name: any; }; },index: any) => (
          ...
          <Col xs={12} sm={12} lg={12} xl={12}>
            <div className='flex-col'>
              ...
              <div className='prop-header-data type-wrap'>
                {pokemonTypeData.damage_relations.double_damage_from.length && (pokemonTypeData.damage_relations.double_damage_from.map((item: { name: any; }, index: any) => (
